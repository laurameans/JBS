...
public struct MainframeUserRepresentable {
    public struct Micro: Codable, Hashable, Equatable, Sendable {
        public init(username: String, profilePicURL: String? = nil, lastConnected: Date? = nil, name: String? = nil, appName: MeansBridgeAppName, id: UUID? = nil, lastIPLog: IPLog? = nil, dailyEngagement: [String: Engagement]?) {
